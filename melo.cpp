...
int main(int argc, char** argv)
{
    ...
    melo::TTS model(core_ptr, args.zh_tts_path,args.tts_device,set_tts_config(args.tts_device, args.quantize), args.zh_bert_path, args.bert_device, args.vocab_bert_path, args.punc_dict_path, args.language, args.disable_bert);
